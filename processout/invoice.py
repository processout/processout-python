...
class Invoice(object):
    ...
    def authorize(self, source, options={}):
        ...
        body = response.body
        invoicesAuthorizeResponse = processout.InvoicesAuthorizeResponse(
            self._client)
        return_values.append(invoicesAuthorizeResponse.fill_with_data(body))
    ...
    def capture(self, source, options={}):
        ...
        body = response.body
        invoicesCaptureResponse = processout.InvoicesCaptureResponse(
            self._client)
        return_values.append(invoicesCaptureResponse.fill_with_data(body))
